        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    FirestName = table.Column<string>(type: "TEXT", nullable: false),
                    LastName = table.Column<string>(type: "TEXT", nullable: false),
                    Email = table.Column<string>(type: "TEXT", nullable: false),
                    Password = table.Column<string>(type: "TEXT", nullable: false),
                    PhoneNumber = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerAuth_Customer_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkerAuth", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkerAuth_Worker_WorkerId",
                        column: x => x.WorkerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkerProfession", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkerProfessionId = table.Column<int>(type: "INTEGER", nullable: false),
                    CustomerId = table.Column<int>(type: "INTEGER", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Project_WorkerProfession_WorkerProfessionId",
                        column: x => x.WorkerProfessionId,
                        principalTable: "WorkerProfession",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Rating_WorkerProfession_WorkerProfessionId",
                        column: x => x.WorkerProfessionId,
                        principalTable: "WorkerProfession",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comment_WorkerId",
                table: "Comment",
                column: "WorkerId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerAuth_CustomerId",
                table: "CustomerAuth",
                column: "CustomerId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Project_WorkerProfessionId",
                table: "Project",
                column: "WorkerProfessionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rating_WorkerProfessionId",
                table: "Rating",
                column: "WorkerProfessionId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkerAuth_WorkerId",
                table: "WorkerAuth",
                column: "WorkerId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkerProfession_WorkerId",
                table: "WorkerProfession",
                column: "WorkerId");
        }
